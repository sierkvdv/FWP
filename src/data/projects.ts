...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description: 'Een surrealistische film gemaakt met verschillende modules van Runway ML die tot leven zijn gekomen. Daarna met glitch effecten aan elkaar gemonteerd voor een unieke, abstracte visuele ervaring.',
    category: 'ai',
    technologies: ['Runway ML', 'After Effects', 'AI Video Generation', 'Glitch Effects', 'Video Editing'],
